...
function App() {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      const response = await axios.get('https://chatbot-3fvb.onrender.com/api/messages');
  ...
  const handleSend = async () => {
    ...
    const response = await axios.post('https://chatbot-3fvb.onrender.com/api/messages', {
      sender: 'user',
      message: input,
    });
